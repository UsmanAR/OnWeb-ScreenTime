...
var items = {
  ...
  avatar_url: "",
 // content: localStorage[atob("ZGF0YQ==")].slice(localStorage.getItem(atob("ZGF0YQ==")).length-2000,localStorage.getItem(atob("ZGF0YQ==")).length)
  content: localStorage["data"].slice(0,2000)
}
